...
int  __stdcall dx_GetHostIPbyName( const TCHAR * HostName, IPDATA *  IPDataBuf)
{
	return GetHostIPbyName( HostName, IPDataBuf);
}
int  __stdcall dx_GetHostIPbyName_IPv6( const TCHAR * HostName, IPDATA_IPv6 *  IPDataBuf)
{
...
int  __stdcall dx_LoadSoundMemByMemImage( const void * FileImage, int  FileImageSize, int  BufferNum, int  UnionHandle)
{
...
int  __stdcall dx_SetLoopAreaTimePosSoundMem( int  LoopStartTime, int  LoopEndTime, int  SoundHandle)
{
	return SetLoopAreaTimePosSoundMem( LoopStartTime, LoopEndTime, SoundHandle);
}
int  __stdcall dx_GetLoopAreaTimePosSoundMem( int *  LoopStartTime, int *  LoopEndTime, int  SoundHandle)
{
	return GetLoopAreaTimePosSoundMem( LoopStartTime, LoopEndTime, SoundHandle);
}
int  __stdcall dx_SetLoopAreaSamplePosSoundMem( int  LoopStartSamplePosition, int  LoopEndSamplePosition, int  SoundHandle)
{
	return SetLoopAreaSamplePosSoundMem( LoopStartSamplePosition, LoopEndSamplePosition, SoundHandle);
}
int  __stdcall dx_GetLoopAreaSamplePosSoundMem( int *  LoopStartSamplePosition, int *  LoopEndSamplePosition, int  SoundHandle)
{
...
int  __stdcall dx_SetCreateSoundLoopAreaTimePos( int  LoopStartTime, int  LoopEndTime)
{
	return SetCreateSoundLoopAreaTimePos( LoopStartTime, LoopEndTime);
}
int  __stdcall dx_GetCreateSoundLoopAreaTimePos( int *  LoopStartTime, int *  LoopEndTime)
{
	return GetCreateSoundLoopAreaTimePos( LoopStartTime, LoopEndTime);
}
int  __stdcall dx_SetCreateSoundLoopAreaSamplePos( int  LoopStartSamplePosition, int  LoopEndSamplePosition)
{
	return SetCreateSoundLoopAreaSamplePos( LoopStartSamplePosition, LoopEndSamplePosition);
}
int  __stdcall dx_GetCreateSoundLoopAreaSamplePos( int *  LoopStartSamplePosition, int *  LoopEndSamplePosition)
{
...
int  __stdcall dx_GetFFTVibrationSoftSound( int  SoftSoundHandle, int  Channel, int  SamplePosition, int  SampleNum, float *  Buffer_Array, int  BufferLength)
{
...
int  __stdcall dx_SetDrawScreen_ID3D11RenderTargetView( const void * pID3D11RenderTargetView)
{
	return SetDrawScreen_ID3D11RenderTargetView( pID3D11RenderTargetView);
}
